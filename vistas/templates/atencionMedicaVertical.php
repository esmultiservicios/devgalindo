                    ...
                    <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <select class="selectpicker" id="estado_civil" name="estado_civil"
                                        data-live-search="true" title="Estado Civil" data-width="100%" data-size="7">
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <select class="selectpicker" id="profesion_id" name="profesion_id"
                                        data-live-search="true" title="Ocupación Actual" data-width="100%"
                                        data-size="7">
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <select class="selectpicker" id="escolaridad" name="escolaridad"
                                        data-live-search="true" title="Escolaridad" data-width="100%" data-size="7">
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="terapeuta_actual" id="terapeuta_actual"
                                    placeholder="Terapeuta Actual" class="form-control" maxlength="100" />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="input-group">
                                            <textarea id="cirugias" name="cirugias" placeholder="Cirugías"
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="input-group">
                                            <textarea id="alergias" name="alergias" placeholder="Alergias"
                                                class="form-control" maxlength="3200" rows="8"></textarea>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                                    <i class="btn btn-outline-success fas fa-microphone-alt"
                                    ...
                                    <div class="card-body">
                                        <div class="input-group">
                                            <textarea id="informacion_adicional" name="informacion_adicional"
                                                placeholder="Información adicional" class="form-control"
                                                maxlength="3200" rows="8"></textarea>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                                    <i class="btn btn-outline-success fas fa-microphone-alt"
