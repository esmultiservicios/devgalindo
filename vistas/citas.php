                ...
                <form class="form-inline" id="botones_citas">
                        ...
                        <div class="input-group">
                            <div class="input-group-append">
                                <span class="input-group-text">
                                    <div class="sb-nav-link-icon"></div>Consultorio
                                </span>
                            </div>
                            <select id="servicio" name="servicio" class="selectpicker" title="Consultorio"
                    ...
                    <div class="form-group mx-sm-3 mb-1">
                        <div class="input-group">
                            ...
                            <select id="medico_general" name="medico_general" class="selectpicker" title="Consultorio"
                                data-live-search="true" data-size="7">
                            </select>
                        </div>
                    </div>
                    <div class="form-group mx-sm-3 mb-1 ml-1">
                        <button class="btn btn-info ml-1" type="submit" id="ausencias">
                            <div class="sb-nav-link-icon"></div><i class="fas fa-user-clock"></i> Ausencias
                        </button>
                        <button class="btn btn-primary ml-1" type="submit" id="refresh">
                            <div class="sb-nav-link-icon"></div><i class="fas fa-sync-alt"></i> Actualizar
                        </button>
                        <button class="btn btn-success ml-1" type="submit" id="search">
                            <div class="sb-nav-link-icon"></div><i class="fas fa-search"></i> Buscar
                        </button>
                        <div class="dropdown show ml-1">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <a class="dropdown-item" id="historial_nopresento" name="historial_nopresento"
                                    href="#">Historial Ausencias</a>
                                <a class="dropdown-item" id="historial_reprogramaciones"
                                    name="historial_reprogramaciones" href="#">Reprogramaciones</a>
                            </div>
                        </div>
                    </div>
                </form>
...
?>
    ...
    <span class="ir-arriba" data-toggle="tooltip" data-placement="top" title="Ir Arriba"><i
            class="fas fa-chevron-up fa-xs"></i></span>
