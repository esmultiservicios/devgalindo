    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-addevent" action="" method="POST" data-form="" autocomplete="off"
                    enctype="multipart/form-data">
                    <input type="hidden" name="paciente_id" class="form-control" id="paciente_id">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="expediente" class="form-control" id="expediente"
                                placeholder="Expediente o Identidad" required="required">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="apellido_proveedores">Profesional</label>
                            <input type="text" name="profesional_citas" readonly class="form-control"
                                id="profesional_citas" required="required">
                        </div>
                        <div class="col-md-4 mb-3">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="fecha_cita_end" class="form-control" id="fecha_cita_end"
                                readonly="readonly" data-toggle="tooltip" data-placement="top" data-toggle="tooltip"
                                data-placement="top" data-toggle="tooltip" data-placement="top"
                                title="Año-Mes-Dia Hora:Minutos:Segundos">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="rtn_proveedores">Hora</label>
                            <input type="time" name="hora" class="form-control" id="hora" placeholder="Hora" readonly
                                data-toggle="tooltip" data-placement="top" title="Año-Mes-Dia Hora:Minutos:Segundos">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary ml-2" type="submit" id="ModalAdd_enviar" form="form-addevent">
...
<div class="modal fade" id="ModalEdit">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="container"></div>
            <div class="modal-body">
                <form id="form-editevent" action="" method="POST" data-form="" autocomplete="off"
                    enctype="multipart/form-data">
                    <input type="hidden" name="paciente_id" class="form-control" id="paciente_id"
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="nombre_proveedores">Expediente</label>
                            <input type="text" name="expediente_edit" class="form-control" id="expediente_edit"
                                placeholder="Expediente" readonly="readonly">
                        </div>
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" name="paciente" class="form-control" id="paciente" placeholder="Paciente"
                                readonly="readonly">
                            <input type="text" name="medico1" class="form-control" id="medico1" readonly="readonly"
                                style="display: none;">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="fecha_citaedit" class="form-control" id="fecha_citaedit"
                                data-toggle="tooltip" data-placement="top" title="Año-Mes-Dia   Hora:Minutos:Segundos">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="hora_nueva">Hora</label>
                            <div class="input-group mb-3">
                                <select class="selectpicker" id="hora_nueva" name="hora_nueva" required
                                    data-live-search="true" title="Hora" data-size="10">
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="rtn_proveedores">Fecha Cita Inicio</label>
                            <input type="text" name="fecha_citaedit1" class="form-control" id="fecha_citaedit1"
                                data-toggle="tooltip" data-placement="top" title="Año-Mes-Dia Hora:Minutos:Segundos"
                                readonly="readonly">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="apellido_proveedores">Fecha Cita End</label>
                            <input type="text" name="fecha_citaeditend" class="form-control" id="fecha_citaeditend"
                                data-toggle="tooltip" data-placement="top" title="Año-Mes-Dia Hora:Minutos:Segundos"
                                readonly="readonly">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="rtn_proveedores">Hora</label>
                            <input type="time" name="hora_citaeditend" class="form-control" id="hora_citaeditend"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="color" class="form-control" id="color" readonly="readonly">-
                                ...
                                <option style="color:#008000;" value="#008000">&#9724; Verde</option>
                                <!--Usuarios Nuevos-->
                                <option style="color:#DF0101;" value="#DF0101">&#9724; Rojo</option>
                                <!--Usuarios Precargados-->
                                <option style="color:#824CC8;" value="#824CC8">&#9724; Morado</option>
                                <!--Usuarios Extemporaneos-->
                                <option style="color:#FF5733;" value="#FF5733">&#9724; Naranja</option>
                                <!--Usuarios Reprogramados-->
                                <option style="color:#B7950B;" value="#B7950B">&#9724; Amarillo</option>
                                <!--Usuarios con mas de 5 años-->
                            </select>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group mb-3">
                                <select class="selectpicker" id="colaborador" name="colaborador" required
                                    data-live-search="true" title="Profesional">
                                </select>
                            </div>
                        </div>
                        <div class="col-md-8 mb-3">
                            <label for="rtn_proveedores">Observación</label>
                            <input type="text" name="coment1" class="form-control" id="coment1"
                                placeholder="Observación" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="rtn_proveedores">Comentario</label>
                            <textarea rows="4" cols="50" name="coment_1" class="form-control" id="coment_1"
                                placeholder="Comentario" readonly="readonly">
					  </textarea>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="rtn_proveedores">Comentario</label>
                            <input type="text" name="coment" class="form-control" id="coment" placeholder="Comentario"
                                required="required">
                        </div>
                    </div>
                    <div class="form-group form-check-inline">
                        <div class="col-md-12 mb-3">
                            <input type="checkbox" name="checkeliminar" class="checkbox-inline" id="checkeliminar"
                                placeholder="Comentario" value="1">
            ...
            <div class="modal-footer">
                <button class="btn btn-warning ml-2" type="submit" id="ModalEdit_enviar" form="form-editevent">
                    <div class="sb-nav-link-icon"></div><i class="far fa-save fa-lg"></i> Modificar
                </button>
                <button class="btn btn-danger ml-2" type="submit" id="ModalDelete_enviar" form="form-editevent">
                    <div class="sb-nav-link-icon"></div><i class="fas fa-trash fa-lg"></i> Eliminar
                </button>
                <button class="btn btn-dark ml-2" type="submit" id="ModalImprimir_enviar" form="form-editevent">
                    <div class="sb-nav-link-icon"></div><i class="fas fa-print fa-lg"></i> Imprimir
                </button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="registrar_ausencias">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="container"></div>
            <div class="modal-body">
                <form class="FormularioAjax" id="formulario_ausencias" action="" method="POST" data-form=""
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <div class="input-group mb-3">
                                <input type="hidden" id="clientes_id" name="clientes_id" class="form-control">
                                <input type="text" id="pro_ausencias" name="pro_ausencias" class="form-control"
                                    readonly>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="medico_ausencia" name="medico_ausencia" class="form-control"
                                data-toggle="tooltip" data-placement="top" title="Seleccione">
                            </select>
                        </div>
                        <div class="col-md-8 mb-3">
                            <label for="apellido_proveedores">Comentario</label>
                            <input type="text" name="comentario_ausencias" id="comentario_ausencias"
                                class="form-control" size="280">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="nombre_proveedores">Fecha Inicio</label>
                            <input type="date" name="fecha_ausencia" id="fecha_ausencia" class="form-control"
                                value="<?php echo date('Y-m-d'); ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="apellido_proveedores">Fecha Fin</label>
                            <input type="date" name="fecha_ausenciaf" id="fecha_ausenciaf" class="form-control"
                                value="<?php echo date('Y-m-d'); ?>">
                        </div>
                    </div>
                    <div class="form-row">
            ...
            <div class="modal-footer">
                <button class="btn btn-success ml-1" type="submit" id="reg_ausencias" form="formulario_ausencias">
                    <div class="sb-nav-link-icon"></div><i class="far fa-save fa-lg"></i> Registrar
                </button>
                <button class="btn btn-info ml-1" type="submit" id="reg_buscarausencias" form="formulario_ausencias">
                    <div class="sb-nav-link-icon"></div><i class="fas fa-sync-alt fa-lg"></i> Buscar
                </button>
            </div>
            ...
            <div class="modal-body">
                <form id="form-buscarcita">
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <input type="text"
                                placeholder="Buscar por: Expediente, Paciente, Medico/Psicólogo o Identidad"
                                id="bs-regis" autofocus class="form-control" />
                        </div>
                    </div>
                    <div class="form-row">
...
<div class="modal fade" id="buscarHistorialReprogramaciones" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
