...
$fecha = $_POST['fecha'];
$colaborador_id = isset($_POST['colaborador_id']) && !empty($_POST['colaborador_id']) ? $_POST['colaborador_id'] : 0;
$servicio_id = isset($_POST['servicio_id']) && !empty($_POST['servicio_id']) ? $_POST['servicio_id'] : 0;
